...
To access Grafana, the username and password may be set to admin and admin, with the Dashboard itself being available at ```http://localhost:3000/dashboards```, under the Services folder.
